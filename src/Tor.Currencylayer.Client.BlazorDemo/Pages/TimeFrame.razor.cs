...
namespace Tor.Currencylayer.Client.BlazorDemo.Pages
{
    public partial class TimeFrame
    {
        ...
        private CurrencylayerResponse<TimeFrameResult> response;
        ...
        private async Task LoadData()
        {
            ...
            this.response = await CurrencylayerClient.GetTimeFrameAsync(startDate, endDate, sourceCurrencyCode, destinationCodes);
